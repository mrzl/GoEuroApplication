package goeuro.application.ssl;
 ...
 * Project: GoEuroTest
 *
 * Taken from http://www.obsidianscheduler.com/blog/ignoring-self-signed-certificates-in-java/.
 *
 * Obviously self-signed certificates are a waste of effort gain no security, trust or whatsoever AT ALL. That's why I've decided for this work around, which simply ignores the
 */
